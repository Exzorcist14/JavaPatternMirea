...
public class ScheduledTask implements TaskMXBean {
  ...
  public void remadeFiles() throws IOException {
    Files.walk(Path.of("C:/study/jaba/task2022/src/main/resources/entities")).filter(Files::isRegularFile).forEach(p -> {
      try {
    ...
    FileWriter banksFile = new FileWriter("C:/study/jaba/task22/src/main/resources/entities/banks.txt");
    banksFile.write(bankService.getBanks().toString());

    FileWriter cardsFile = new FileWriter("C:/study/jaba/task22/src/main/resources/entities/cards.txt");
